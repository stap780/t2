...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference("Feature.count") do
      post features_url, params: { feature: { characteristic_id: @feature.characteristic_id, product_id: @feature.product_id, property_id: @feature.property_id } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { characteristic_id: @feature.characteristic_id, product_id: @feature.product_id, property_id: @feature.property_id } }
